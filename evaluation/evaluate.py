...
if __name__ == "__main__":
    src_list, mt_list, ref_list = load_data("./evaluation/test_data/text_data_test.en", "./evaluation/test_data/dovebench_mt.zh", "./evaluation/test_data/dovebench_gt.zh")
    print("-----------data loaded-----------")
    cal_all_scores(src_list, mt_list, ref_list, csv_path="./evaluation/test_data/dovebench_result.csv")
